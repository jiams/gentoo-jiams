...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gnome-shell-extensions/gnome-shell-extensions-3.01.0.ebuild,v0.1 2013/09/15 21:27:49 eva Exp $
# http://ftp.acc.umu.se/pub/GNOME/sources/gnome-shell-extensions/3.10/gnome-shell-extensions-3.10.0.tar.xz
EAPI="5"
GCONF_DEBUG="no"
...
COMMON_DEPEND="
	...
	>=gnome-base/libgtop-2.28.5[introspection]
...
RDEPEND="${COMMON_DEPEND}
	...
	>=gnome-base/gnome-shell-3.10.0.1
